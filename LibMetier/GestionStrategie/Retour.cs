...
namespace LibMetier.GestionStrategie
{
    public class Retour : StrategieAbstraite
    {
        ...
        public override void Deplacement(int dimX, int dimY, PersonnageAbstrait unPerso)
        {
            ...
            Console.WriteLine("Pos X : " + unPerso.Position.X);
            Console.WriteLine("Mais X : " + unPerso.Maison.X);
            Console.WriteLine("Pos Y : " + unPerso.Position.Y);
            Console.WriteLine("Mais Y : " + unPerso.Maison.Y);
